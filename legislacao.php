    ...
    <body>
        <header>
            <h1 class="site-heading text-center text-faded d-none d-lg-block">
                ...
                <span class="site-heading-upper">Legislação</span>
            </h1>
        </header>
        <!-- Navigation-->
        <nav class="navbar navbar-expand-lg navbar-dark py-lg-4" id="mainNav">
            <div class="container">
                <a class="navbar-brand text-uppercase fw-bold d-lg-none" href="legislacao.php">Legislação</a>
                        ...
                        <div class="cta-inner bg-faded text-center rounded">
                            ...
                            <ul class="list-unstyled list-hours mb-5 text-left mx-auto">
                                <li style="color: #000; font-weight: 100;" class="list-unstyled-item list-hours-item d-flex">
                                    ...
                                    <span class="ms-auto"><a style="text-decoration: none;" target="_blank" href="/legislacao/cerimonial.html">JOGAR</a></span>
                                </li>
                                <li style="color: #000; font-weight: 100;" class="list-unstyled-item list-hours-item d-flex">
                                    Estatuto dos Militares
                                    <span class="ms-auto"><a style="text-decoration: none;" target="_blank" href="/legislacao/estatuto-dos-militares.html">JOGAR</a></span>
                                </li>
                                <li style="color: #000; font-weight: 100;" class="list-unstyled-item list-hours-item d-flex">
                                    RDM
                                    <span class="ms-auto"><a style="text-decoration: none;" target="_blank" href="/legislacao/rdm.html">JOGAR</a></span>
                                </li>
                                <li style="color: #000; font-weight: 100;" class="list-unstyled-item list-hours-item d-flex">
                                    OGSA
                                    <span class="ms-auto"><a style="text-decoration: none;" target="_blank" href="/legislacao/ogsa.html">JOGAR</a></span>
                                </li>
                            </ul>
                        </div>
                    </div>
